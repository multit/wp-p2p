                ...
                <div class="columns small-12 show-for-small-only">
                  <h3 class="random_colored">Italian Center for Global Health<i class="fa fa-bars"></i>
                </div>
                ...
                <div class="columns medium-8 show-for-medium-up">
                    <ul class="inline-list">
                        ...
                        <li class="menu-btn"><a href="" class="menuAnimated HPscroller" section="#news">News</a></li>
                        <li class="menu-btn"><a href="" class="menuAnimated HPscroller" section="#maps">Maps</a></li>
                        <li class="menu-btn"><a href="" class="menuAnimated">Search</a></li>
                    </ul>
                </div>
